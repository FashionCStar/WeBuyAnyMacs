<?php
add_action('wp_ajax_get_products_by_cat', 'get_products_by_cat');
...
add_action('wp_ajax_set_cart_total_with_wait', 'set_cart_total_with_wait');

function set_cart_total_with_wait()
{

    $cart_total = intval($_POST['cart_total']);
