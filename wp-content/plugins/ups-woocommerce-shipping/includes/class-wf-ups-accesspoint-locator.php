	...
	class wf_ups_accesspoint_locator{
		...
		public function wf_ups_add_accesspoint_to_checkout_fields( $fields ) {
			$fields['billing']['shipping_accesspoint'] = array(
				'label'       => __('Access Point Locations', 'ups-woocommerce-shipping'),
				...
				'options'     => array(
					'' => __('Select Access Point Location', 'ups-woocommerce-shipping' )
					)
			);
		 ...
		 * Debug logs.
		 */
		public function debug_log( $heading, $data, $source ="Ph-UPS-Logs" ){
