...
if( !class_exists('WF_UPS_Admin_Options') ){
    class WF_UPS_Admin_Options{
        ...
        function init(){
            ...
            add_action( 'woocommerce_product_options_shipping', array($this,'wf_add_custom_field_ups'), 1 );

            //Saving the values
            add_action( 'woocommerce_process_product_meta', array( $this, 'wf_save_custom_field_ups' ), 1 );
        }
