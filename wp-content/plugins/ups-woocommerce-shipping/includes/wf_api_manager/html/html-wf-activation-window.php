...
<div class="activation_window">
	<h2 class="aw-title"><span>License Activation</span></h2>
	<div class="aw-contents-container">
		<div id="aw-activation" class="content-row <?php echo $show_activation?>">
			...
			<div class="content-row" style="float: left;">
				<p class="aw-note-cell">Check <a href="https://www.pluginhive.com/my-account" target="_blank">My Account</a> for API Keys and API Downloads.</p>
			</div>
		</div>
		...
		if ( licence_key.length > 0 ) {
			...
			jQuery.get( ajax_url, submit_data, function( data ) {
				...
				if(typeof formatted_data.error != "undefined"){
					...
					add_style = 'updated';
					remove_style = 'error';
					html_msg = "<p><strong> The license has been deactivated successfully.</strong></p>";
