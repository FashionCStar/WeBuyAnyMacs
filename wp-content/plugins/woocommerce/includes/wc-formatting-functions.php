...
function wc_price( $price, $args = array() ) {
	...
	$formatted_price = ( $negative ? '-' : '' ) . sprintf( $args['price_format'], '<span class="woocommerce-Price-currencySymbol">' . get_woocommerce_currency_symbol( $args['currency'] ) . '</span>', '<span class="woocommerce-current_Price">'.$price.'</span>' );
